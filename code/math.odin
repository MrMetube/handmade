...
///////////////////////////////////////////////
////                                       ////
////  THIS CODE IS COPYPASTA. DO NOT EDIT  ////
////                                       ////
///////////////////////////////////////////////
...
@(require_results) safe_ratio_n_f :: proc(numerator, divisor, n: f32) -> f32 {
    ratio := n
...
@(require_results) safe_ratio_n_v :: proc(numerator: $V/[$N]f32, divisor, n: V) -> V {
    ratio := n
...
@(require_results) safe_ratio_0_f :: proc(numerator, divisor: f32) -> f32 { return safe_ratio_n(numerator, divisor, 0) }
@(require_results) safe_ratio_0_v :: proc(numerator: $V, divisor: V) -> V { return safe_ratio_n(numerator, divisor, cast(V) 0) }

safe_ratio_1 :: proc { safe_ratio_1_f, safe_ratio_1_v }
@(require_results) safe_ratio_1_f :: proc(numerator, divisor: f32) -> f32 { return safe_ratio_n(numerator, divisor, 1) }
@(require_results) safe_ratio_1_v :: proc(numerator: $V, divisor: V) -> V { return safe_ratio_n(numerator, divisor, 1) }
